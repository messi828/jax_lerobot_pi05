...
class Eagle25VLImageProcessorFast(BaseImageProcessorFast):
    ...
    def preprocess(
        ...
        **kwargs: Unpack[Eagle25VLFastImageProcessorKwargs],
        ...
        # Compatibility: use _prepare_image_like_inputs (transformers>=4.53) or _prepare_input_images
        _prepare_fn = getattr(self, "_prepare_image_like_inputs", None) or self._prepare_input_images
