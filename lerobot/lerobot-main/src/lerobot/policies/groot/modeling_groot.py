...
class GrootPolicy(PreTrainedPolicy):
    ...
    def _create_groot_model(self):
        ...
        if getattr(self.config, "gradient_checkpointing", False) and hasattr(model, "backbone"):
            backbone = model.backbone
            if hasattr(backbone, "eagle_model"):
                backbone.eagle_model.gradient_checkpointing_enable()
                print("[GROOT] Gradient checkpointing enabled on Eagle backbone (saves VRAM, slower step).")
