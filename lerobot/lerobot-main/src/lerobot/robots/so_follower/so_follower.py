...
class SOFollower(Robot):
    ...
    def get_observation(self) -> RobotObservation:
        ...
        # Serial buses can occasionally drop a packet; allow a retry budget to avoid
        # aborting an episode due to a transient "There is no status packet!" error.
    ...
    def send_action(self, action: RobotAction) -> RobotAction:
        ...
        self.bus.sync_write("Goal_Position", goal_pos, num_retry=1)
