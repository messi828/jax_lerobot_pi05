...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> "Teleoperator":
    ...
    elif config.type == "so101_leader_spacebar_follow":
        from .so_leader_spacebar_follow import SOLeaderSpacebarFollowTeleop

        return SOLeaderSpacebarFollowTeleop(config)
